...
document.getElementById('login-form').addEventListener('submit', async function (e) {
  ...
  if (username === 'ambulatorio' && password === 'ambulatorio') {
    const powerBIUrl = "https://app.powerbi.com/view?r=eyJrIjoiMWMxNWU3MDctMzczZi00YTE2LWFiYmQtNmYwNDhhNzk2MDcyIiwidCI6IjNhNzhiMGNkLTdjOGUtNDkyOS08M2Q1LTE5MGE2Y2MwMTM2NSJ9";
    ...
    try {
      await fetch("https://script.google.com/macros/s/AKfycbwVOSZnHUeKfRUyxy66QGegekodo8H4Hsf1efk2awz2w7ZCCjTmT8hSww2HEJ4cJOMZ6Q/exec", {
        ...
        body: new URLSearchParams({ setor: "Fonoaudiologia" })
      });
    } catch (error) {
